...
public class Product {
    ...
    public Product(String product_name, String product_Kind, String describtion, String abstract_Category_Id, int popularity_Point, int userPoint, int price, String imageURL, List<String> likedusersids, List<String> dislikedusersids, List<String> reviewsId,String id_Owner_Shop
